...
Итог: Layer 1 закрывает 2,8–22,7 % ячеек (точность 87,0–100 % в зависимости от категории и шаблона); Layer 2 — 71,9–93,7 % (93,5–98,6 %); Layer 4 — 3,5–8,2 % (67,2–78,8 % в зависимости от модели). Среднее ECE по Layer 2 — 0,070; серебряная пост-калибровка устойчивого эффекта не даёт.
