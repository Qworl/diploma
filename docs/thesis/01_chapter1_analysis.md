...
**Ф-4. Автоматическое определение категории.** Если категория явно не указана, система определяет её автоматически по поступившему текстовому описанию товара. Эта функция реализуется отдельным предкаскадным слоем (Layer 0).
