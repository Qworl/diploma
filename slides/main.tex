...
\textbf{проверку на непересекающихся брендах} и \textbf{гибридную архитектуру} одновременно.
\end{frame}
...
\begin{itemize}
    ...
    \item \textbf{N3.} Обобщение на непересекающихся брендах.
...
\vspace{0.5em}
\textbf{Протокол:} проверка на непересекающихся брендах.\\
...
\begin{itemize}
    ...
    \item проверка на непересекающихся брендах: основная выборка $n{=}3257$ + проверочная $n{=}615$ (нижняя оценка);
...
(на серебряной разметке, 15\,тыс. товаров на непересекающихся брендах);
...
\vspace{0.3em}
\textbf{Разбиение по непересекающимся брендам (60/20/20).}
